...
import { Brain, ArrowRight, Mail, Lock, Eye, EyeOff } from "lucide-react";
      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 mt-2">
            {isSignUp
              ? "Start discovering revenue opportunities today"
        ...
        <div className="card !p-8">
          ...
          <div className="space-y-3 mb-6">
            <button className="w-full flex items-center justify-center gap-3 py-3 rounded-xl border border-white/10 hover:border-white/20 hover:bg-white/5 transition-all text-sm text-slate-300">
